...
INFO = [
    ...
    "<div style='background-color: blue; width: 20px; height: 20px; display: inline-block;'></div> Only the Svara is present in the word (Vyanjana may or may not be present)",
    "<div style='background-color: purple; width: 20px; height: 20px; display: inline-block;'></div> At least one Vyanjana is present in the word (Svara may or may not be present)",
